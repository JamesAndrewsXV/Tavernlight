...
SpellInfo = {
  ['Default'] = {
    ...
    ['Tornado Attack'] =            {id = 420, words = 'aer',                 exhaustion = 1,     premium = false,  type = 'Instant', icon = 'eternalwinter',         mana = 0,      level = 1,  soul = 0, group = {[1] = 4000},               vocations = {2, 6}}
